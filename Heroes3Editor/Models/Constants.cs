...
namespace Heroes3Editor.Models
{
    public class Constants
    {
        ...
        public static string[] Heroes { get; } =
        {
            ...
            "Elmore", "Illor", "Jeremy", "Leena", "Miriam", "Bidley", "Tark", "Andal", "Astra", "Casmetra", "Dargem",
            "Eovacius", "Manfred", "Spint", "Zilare"
        };
    ...
    public class Artifacts
    {
        ...
        public string this[byte key]
        {
            ...
            {
                string val = "";
                _namesByCode.TryGetValue(key, out val);
                return val ?? $"Unkown Artifact {(int)key}";
            } 
        }
    ...
    public class Creatures
    {
        ...
        public string this[byte key]
        {
            ...
            {
                string value = "";
                _namesByCode.TryGetValue(key, out value);
                return value ?? $"Unkown Creature {(int)key}";
            }
        }
